...
var reRoute = /([A-Z]+)?\s?([^\s]*)\s+=\>\s+(.*)/;
var reHandlerDelim = /[\.\/]/;
var reLeadingAndTrailingSlashes = /^\/|\/$/;
...
Ruleset.prototype.add = function(method, pattern, handlerPath) {
  var matchResult;
  var handlerParts;
  var handlerFilename;
  var handlerMethod;
...
Ruleset.prototype.mount = function(mountpoint) {
